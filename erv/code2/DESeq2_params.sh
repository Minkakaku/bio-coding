...
deseq2_output_dir="./DIFF_TE";

# We need to define the count or tpm files by having a list of each set in
# a text file, one per line.

deseq2_file_list_1="CTX_mut_tpm_list.txt";

sample_name_1="CTX_MUT";

deseq2_file_list_2="CTX_het_tpm_list.txt";

sample_name_2="CTX_HET";
...
DESeq2_output_file="CTX_MvsH_deseq2_express.txt";
