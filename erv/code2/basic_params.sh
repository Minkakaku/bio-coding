...
path_to_dmap="/data/gpfs02/wmo/software/DMAP-master/src/";
...
genome_fasta_file="/data/gpfs02/wmo/genome/GRCm39/GRCm39.genome.fa"

# the location where the index files are written and read from

star_genome_dir="/data/gpfs02/wmo/genome/reference/STAR_index_GRCm39";
...
ucsc_repeat_src="/data/gpfs02/wmo/genome/GRCm39/rep/mm39_ucsc_repeats.txt.gz"
...
gencode_gene_gtf_src="/data/gpfs02/wmo/genome/GRCm39/gencode.vM27.annotation.gtf"
...
repeat_gene_gtf_dir="/data/gpfs02/wmo/genome/GRCm39/rep/";
