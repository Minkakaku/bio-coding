...
# rm(list = ls())
# rds = "/lvdata/wzb/scRNA/FWSC20240471/2024.11.12/Pseudotime/Pseudotime.monocle.rds"
# branchPoint = 1
# qvalueCutOff = 0.0001
# TopGeneNum = 100
# genelist = NULL
# numClusters = 3
# outpath = '/lvdata/wzb/scRNA/FWSC20240471/2024.11.12/BEAM'
...
getgene = function(seuCDS,cds_subset,genelist,qvalueCutOff,TopGeneNum){
  if (is.null(genelist)) {
    ...
    # rds  = readRDS('/lvdata/wzb/scRNA/FWSC20240471/2024.11.12/h5_trans.rds')
    ...
    # BEAM_res = read.csv('/lvdata/wzb/scRNA/FWSC20240471/2024.11.12/BEAM/AllBEAMGene.txt',sep = "\t")
    # qvalueCutOff  =2
...
mainfun = function(rds,branchPoint,genelist,numClusters,qvalueCutOff,TopGeneNum){
  ...
  # genes  = read.csv('/lvdata/wzb/scRNA/FW2024-213/2024.05.20/NK/BEAM1/AllBEAMGene.txt',sep = "\t")
...
# outpath = "/home/wzb/Pseudotime/Neutrophil/l7result/"
# rds = "/home/wzb/Pseudotime/Neutrophil/l7result/Pseudotime.monocle.rds"
# branchPoint=1
# genelist = NULL
# numClusters = 3
# qvalueCutOff = 0.0001
