...
sc.pp.log1p(adata)
sc.tl.rank_genes_groups(adata, 'leiden_r1', method='wilcoxon', n_genes=3000)
adata.write('./de.h5ad')
...
TEs = set(genelist(filename='hg_TE_name.txt', format={'name': 0, 'force_tsv': True})['name'])
...
print(joined)
sc.pl.dotplot(adata, joined, groupby='leiden_r1', dot_max=0.7, dendrogram=True, standard_scale='var', show=False, save='de-tes.pdf')
sc.pl.matrixplot(adata, joined, groupby='leiden_r1', dendrogram=True, standard_scale='var', show=False, save='de-tes.pdf')
